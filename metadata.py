# Este arquivo contém os metadados usados para gerar o README.md.
...
metadata = {
    ...
    '0094': {
        'tags': ['Depth-First Search', 'Stack', 'Tree'],
        'difficulty': 'Easy'
    },
    '0095': {
        'tags': ['Backtracking', 'Dynamic Programming', 'Tree'],
        'difficulty': 'Medium'
    },
    '0096': {
    ...
    '0124': {
        'tags': ['Depth-First Search', 'Dynamic Programming', 'Tree'],
        'difficulty': 'Hard'
    },
    '0125': {
    ...
    '0148': {
        'tags': ['Divide and Conquer', 'Linked List', 'Two Pointers'],
        'difficulty': 'Medium'
    },
    '0149': {
    ...
    '0211': {
        'tags': ['Design', 'Depth-First Search', 'String'],
        'difficulty': 'Medium'
    },
    '0212': {
        'tags': ['Array', 'Backtracking', 'String'],
    ...
    '0269': {
        'tags': ['Array', 'Depth-First Search', 'String'],
        'difficulty': 'Hard'
    },
    '0274': {
    ...
    '0295': {
        'tags': ['Design', 'Sorting', 'Two Pointers'],
        'difficulty': 'Hard'
    },
    '0300': {
    ...
    '0394': {
        'tags': ['Recursion', 'Simulation', 'Stack', 'String'],
        'difficulty': 'Medium'
    },
    '0399': {
        'tags': ['Array', 'Depth-First Search', 'String'],
    ...
    '0509': {
        'tags': ['Dynamic Programming', 'Math', 'Memoization', 'Recursion'],
        'difficulty': 'Easy'
    },
    '0511': {
        'tags': ['Database'],
    ...
    '0528': {
        'tags': ['Array', 'Binary Search', 'Math', 'Prefix Sum'],
        'difficulty': 'Medium'
    },
    '0530': {
        'tags': ['Breadth-First Search', 'Depth-First Search', 'Tree'],
    ...
    '0611': {
        'tags': ['Array', 'Binary Search', 'Two Pointers', 'Greedy', 'Sorting'],
        'difficulty': 'Medium'
    },
    '0619': {
        'tags': ['Database'],
    ...
    '0673': {
        'tags': ['Array', 'Binary Indexed Tree', 'Dynamic Programming'],
        'difficulty': 'Medium'
    },
    '0682': {
    ...
    '0721': {
        'tags': ['Array', 'Hash Table', 'String', 'Union Find', 'Breadth-First Search', 'Depth-First Search'],
        'difficulty': 'Medium'
    },
    '0724': {
        'tags': ['Array', 'Prefix Sum'],
    ...
    '0863': {
        'tags': ['Depth-First Search', 'Hash Table', 'Tree', 'Breadth-First Search'],
        'difficulty': 'Medium'
    },
    '0864': {
    ...
    '0976': {
        'tags': ['Array', 'Greedy', 'Math', 'Sorting'],
        'difficulty': 'Easy'
    },
    '0981': {
        'tags': ['Binary Search', 'Hash Table', 'String', 'Design'],
        'difficulty': 'Medium'
    },
    '0983': {
        'tags': ['Array', 'Dynamic Programming'],
    ...
    '1027': {
        'tags': ['Array', 'Binary Search', 'Dynamic Programming', 'Hash Table'],
        'difficulty': 'Medium'
    },
    '1035': {
        'tags': ['Array', 'Dynamic Programming'],
    ...
    '1041': {
        'tags': ['Math', 'Matrix', 'Simulation', 'String'],
        'difficulty': 'Medium'
    },
    '1045': {
        'tags': ['Database'],
    ...
    '1146': {
        'tags': ['Array', 'Binary Search', 'Hash Table', 'Design'],
        'difficulty': 'Medium'
    },
    '1148': {
        'tags': ['Database'],
    ...
    '1268': {
        'tags': ['Array', 'Binary Search', 'String', 'Trie'],
        'difficulty': 'Medium'
    },
    '1275': {
    ...
    '1857': {
        'tags': ['Dynamic Programming', 'Graph', 'Hash Table', 'Topological Sort'],
        'difficulty': 'Hard'
    },
    '1873': {
        'tags': ['Database'],
    ...
    '2462': {
        'tags': ['Array', 'Heap (Priority Queue)', 'Two Pointers'],
        'difficulty': 'Medium'
    },
    '2466': {
        'tags': ['Dynamic Programming'],
